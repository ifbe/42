...
int ev3d_stop(struct arena* twig, void* tf, struct arena* root, void* rf)
{
	return 0;
}
int ev3d_start(struct arena* twig, void* tf, struct arena* root, void* rf)
{
	struct relation* rel;
	struct style* sty;
	struct actor* act;
...
int ev3d_delete(struct arena* win)
{
	return 0;
}
