...
void window_create(_obj* wnd)
{
	...
	wnd->mt20list.world[0].camera = (struct mt20data**)memory_alloc_align(0x10000, 0);
	wnd->mt20list.world[0].light  = (struct mt20data**)memory_alloc_align(0x10000, 0);
	wnd->mt20list.world[0].solid  = (struct mt20data**)memory_alloc_align(0x10000, 0);
	wnd->mt20list.world[0].opaque = (struct mt20data**)memory_alloc_align(0x10000, 0);
	thewnd = wnd;
