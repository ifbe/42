#include "libuser.h"
int avfcam_take(_obj* cam,void* foot, _syn* stack,int sp, p64 arg,int idx, u8* buf,int len);
int avfcam_give(_obj* cam,void* foot, _syn* stack,int sp, p64 arg,int idx, u8* buf,int len);
int avfcam_attach();
int avfcam_detach();
int avfcam_reader(_obj* cam,void* foot, p64 arg,int idx, u8* buf,int len);
int avfcam_writer(_obj* cam,void* foot, p64 arg,int idx, u8* buf,int len);
