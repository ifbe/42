...
int mfcam_take(_obj* cam,void* foot, _syn* stack,int sp, void* arg,int idx, u8* buf,int len);
int mfcam_give(_obj* cam,void* foot, _syn* stack,int sp, void* arg,int idx, u8* buf,int len);
int mfcam_attach();
int mfcam_detach();
int mfcam_reader(_obj* cam,void* foot, void* arg,int idx, u8* buf,int len);
int mfcam_writer(_obj* cam,void* foot, void* arg,int idx, u8* buf,int len);
