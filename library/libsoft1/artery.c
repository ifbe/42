...
int ann_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int ann_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int cnn_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int cnn_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//file
...
int pump_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int pump_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int stor_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int stor_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int fileclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int fileclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int ntfsclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int ntfsclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int extclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int extclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//
...
int control_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int control_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int search_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int search_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int vt100_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int vt100_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//
...
int echo_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int echo_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int goslow_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int goslow_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int dbgf32_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int dbgf32_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int dbghex_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int dbghex_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//
...
int fftpcm_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int fftpcm_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int fftrgb_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int fftrgb_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int rotate_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int rotate_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int scale_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int scale_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//
...
int recut_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int reline_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int reorder_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int reorder_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//
...
int qu2eu_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int qu2eu_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int easyag_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int easyag_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int mahony_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int mahony_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int madgwick_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int madgwick_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//uart.gcode
...
int gcodeclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int gcodeclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int gcodeserver_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int gcodeserver_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int mavlinkclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int mavlinkclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int mavlinkserver_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int mavlinkserver_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int nema0183client_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int nema0183client_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int nema0183server_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int nema0183server_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//socket
...
int proxyclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int proxyclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int proxyserver_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int proxyserver_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int proxymaster_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int socksclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int socksclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int socksserver_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int socksserver_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int socksmaster_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int socksmaster_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//udp.dns
...
int ntpclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int ntpclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int ntpserver_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int ntpserver_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//udp.bootp
...
int bootpclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int bootpclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int bootpserver_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int bootpserver_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//udp.dhcp
...
int dhcpclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int dhcpclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int dhcpserver_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int dhcpserver_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//udp.tftp
...
int rdpclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int rdpclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int rdpserver_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int rdpserver_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int rdpmaster_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int rdpmaster_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//tcp.vnc
...
int vncclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int vncclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int vncserver_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int vncserver_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int vncmaster_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int vncmaster_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//tcp.http
...
int httpclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int httpserver_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int httpserver_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int httpmaster_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//tcp.ws
...
int wsclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int wsclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int wsserver_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int wsserver_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int wsmaster_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int wsmaster_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//tcp.tls1.2
...
int fuckgfwclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int fuckgfwclient_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int fuckgfwserver_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int fuckgfwserver_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int fuckgfwmaster_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
int fuckgfwmaster_read( _art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
//tcp.party
...
int partyclient_write(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, u8* buf, int len);
...
int arteryread(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, void* buf, int len)
{
	switch(art->type){
		...
		case _gpt_:gptclient_read(art,foot, stack,sp, arg,idx, buf,len);break;
		case _mbr_:mbrclient_read(art,foot, stack,sp, arg,idx, buf,len);break;

		case _fat_:fatclient_read(art,foot, stack,sp, arg,idx, buf,len);break;
		case _hfs_:hfsclient_read(art,foot, stack,sp, arg,idx, buf,len);break;
...
int arterywrite(_art* art,int foot, _syn* stack,int sp, void* arg, int idx, void* buf, int len)
{
	...
	switch(art->type){
		...
		case _gpt_:return gptclient_write(art,foot, stack,sp, arg,idx, buf,len);break;
		case _mbr_:return mbrclient_write(art,foot, stack,sp, arg,idx, buf,len);break;
