...
static void guiapp_mgr_to_ent(_obj* mgr)
{
	...
	struct relation* rel1 = relationcreate(mgr,mgr_to_term, _ent_,0, term,term_to_mgr, _ent_,0);
...
/*
	...
	struct relation* rel2 = relationcreate(mgr,mgr_to_game, _ent_,0, game,game_to_mgr, _ent_,0);
...
static void guiapp_wnd_to_mgr(_obj* wnd)
{
	...
	struct relation* rel0 = relationcreate(wnd,wnd_to_mgr, _sup_,0, mgr,mgr_to_wnd, _ent_,0);
...
static void guiapp_wnd_to_3d(_obj* wnd)
{
	...
	struct relation* rel2 = relationcreate(wrd,wrd_to_cam, _ent_,0, cam,cam_to_wrd, _ent_,_in_);
	relationattach((void*)&rel2->srcchip, (void*)&rel2->dstchip);
	...
	struct relation* rel3 = relationcreate(wrd,wrd_to_abc, _ent_,0, abc,abc_to_wrd, _ent_,0);
	...
	struct relation* rel1 = relationcreate(wnd,wnd_to_cam, _sup_,0, cam,cam_to_wnd, _ent_,0);
	relationattach((void*)&rel1->srcchip, (void*)&rel1->dstchip);
