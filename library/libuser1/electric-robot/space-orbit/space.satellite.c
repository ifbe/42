...
static void satellite_read_byworld_bycam_bywnd(_obj* ent,void* slot, _syn* stack,int sp)
{
...
static void satellite_read_bywnd(_obj* ent,void* foot, _syn* stack,int sp)
{
}
...
static void satellite_taking(_obj* ent,void* foot, _syn* stack,int sp, p64 arg,int key, void* buf,int len)
{
	...
	switch(caller->type){
	case _wnd_:
		satellite_read_bywnd(ent,foot, stack,sp);
		break;
	default:
		satellite_read_byworld_bycam_bywnd(ent,foot, stack,sp);
		break;
	}
}
