...
static void tff_wrl_cam_wnd(_obj* ent,void* slot, _syn* stack,int sp)
{
...
static void tff_taking(_obj* ent,void* foot, _syn* stack,int sp, void* arg,int key, void* buf,int len)
{
	if(0 == stack)return;
