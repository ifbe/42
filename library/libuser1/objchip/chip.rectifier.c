...
static void rectify_sread(struct halfrel* self, struct halfrel* peer, u8* buf, int len)
{
	//if 'draw' == self.foot
...
static void rectify_swrite(struct halfrel* self, struct halfrel* peer, u8* buf, int len)
{
}
static void rectify_cread(struct halfrel* self, struct halfrel* peer, u8* buf, int len)
{
}
static void rectify_cwrite(struct halfrel* self, struct halfrel* peer, u8* buf, int len)
{
}
