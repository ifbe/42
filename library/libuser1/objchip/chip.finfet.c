...
static void finfet_sread(struct halfrel* self, struct halfrel* peer, u8* buf, int len)
{
	//if 'draw' == self.foot
...
static void finfet_swrite(struct halfrel* self, struct halfrel* peer, u8* buf, int len)
{
}
static void finfet_cread(struct halfrel* self, struct halfrel* peer, u8* buf, int len)
{
}
static void finfet_cwrite(struct halfrel* self, struct halfrel* peer, u8* buf, int len)
{
}
...
void finfet_register(struct actor* p)
{
	...
	p->oncread  = (void*)finfet_cread;
	p->oncwrite = (void*)finfet_cwrite;
	p->onsread  = (void*)finfet_sread;
	p->onswrite = (void*)finfet_swrite;
}
