...
static void nmos_read(_ent* ent,int foot, _syn* stack,int sp, void* arg,int key, u8* buf,int len)
{
	switch(foot){
...
static void nmos_write(_ent* ent,int foot, _syn* stack,int sp, void* arg,int key, u8* buf,int len)
{
