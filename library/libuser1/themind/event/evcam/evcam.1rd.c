...
int cam1rd_taking(_ent* ent,int foot, _syn* stack,int sp, void* arg,int key, void* buf,int len)
{
...
int cam1rd_giving(_ent* ent,int foot, _syn* stack,int sp, void* arg,int key, struct event* ev, int len)
{
	return 0;
}
