...
{
	act->dx_camera = memorycreate(0x10000, 0);
	act->dx_light  = memorycreate(0x10000, 0);
	act->dx_solid  = memorycreate(0x10000, 0);
	act->dx_opaque = memorycreate(0x10000, 0);
	return 0;
}
