...
"const mediump float PI = 3.1415926535897932384626433832795028841971693993151;\n"
"mediump float getD(mediump float v, mediump float r){\n"
    "mediump float a2 = r*r*r*r;\n"
    "mediump float de = (v*v * (a2 - 1.0) + 1.0);\n"
    "return a2 / (PI * de * de);\n"
"}\n"
"mediump float getG(mediump float v, mediump float r){\n"
    "mediump float k = (r+1.0) * (r+1.0) / 8.0;\n"
    "return v / (v * (1.0 - k) + k);\n"
"}\n"
"void main(){\n"
