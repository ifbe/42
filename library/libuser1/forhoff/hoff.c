...
int hoffdata_read(struct halfrel* self, struct halfrel* peer, void* arg, int idx, void* buf, int len)
{
	...
	struct entity* data = (void*)(self->chip);
	if(0 == data)return 0;
...
int hoffdata_search(struct supply* win)
{
	return 0;
}
int hoffdata_modify(struct supply* win)
{
	return 0;
}
int hoffdata_delete(struct supply* win)
{
	return 0;
}
int hoffdata_create(struct entity* act, void* flag)
{
    return 0;
}
