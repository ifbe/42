...
static void nmos_write_B(struct halfrel* self, struct halfrel* peer, struct halfrel** stack, int rsp, u8* buf, int len)
{
}
...
{
	nmos_read_bycam(self,peer, stack,rsp, buf,len);
}
