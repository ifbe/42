...
static void isrc_read(struct halfrel* self, struct halfrel* peer, u8* buf, int len)
{
	//if 'draw' == self.foot
...
static void isrc_search(struct actor* act, u8* buf)
{
}
static void isrc_modify(struct actor* act, u8* buf)
{
}
