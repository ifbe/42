...
static void aidgeom_read(struct halfrel* self, struct halfrel* peer, u8* buf, int len)
{
}
static void aidgeom_write(struct halfrel* self, struct halfrel* peer, u8* buf, int len)
{
}
...
static void aidgeom_search(struct actor* act)
{
}
static void aidgeom_modify(struct actor* act)
{
}
...
void aidgeom_register(struct actor* p)
{
	...
	p->onsearch = (void*)aidgeom_search;
	p->onmodify = (void*)aidgeom_modify;

	p->onstart = (void*)aidgeom_start;
	p->onstop  = (void*)aidgeom_stop;
	p->onread  = (void*)aidgeom_read;
	p->onwrite = (void*)aidgeom_write;
}
